...
const DentalPostCardFirst = ({ post, index }) => {
  return (
    <div
    ...
    >
      <div className="blog-item rounded overflow-hidden">
        <div
          className="blog-img position-relative img-thumbnail border-0 overflow-hidden"
          style={{ height: "180px" }}
        >
          <img
          ...
          <Link
            to={`/posts/category/${post.postcategory.slug}`}
            key={post.postcategory.slug}
            className="badge badge-dark text-white py-1"
...
const DentalPostCardSecond = ({ post }) => {
  return (
    <div
      className="col-md-6 wow slideInUp mb-4"
    >
      <div className="blog-item rounded overflow-hidden">
        <div
          className="blog-img position-relative img-thumbnail border-0 overflow-hidden"
    ...
    <div className="container">
      ...
      <div className="row mt-5">
        <div className="col-lg-8">
          ...
          {posts.length > 0 && posts[0].postcategory.slug == 'dental-news' ?
            <div className="row mb-5">
                ...
                <hr style={{"position":"relative","color":"#607d8b","width":"90%","margin":"auto","height":"4px"}}/>
            </div> : ''
          }
            ...
            <div className="row mb-5">
                {posts.map((post, index) => {
                  if(index == 3 || index == 4 || index == 5) {
                    return <DentalPostCardFirst post={post} />;
                 }
                })}
                <hr style={{"position":"relative","color":"#607d8b","width":"90%","margin":"auto","height":"4px"}}/>
            </div> : ''
          ...
          <div className="row">
            {posts.length > 0 && posts[0].postcategory.slug == 'dental-news' ? 
             posts.map((post, index) => {
               if(index > 5) {
                return <DentalPostCardSecond post={post} index={index} />;
               }
