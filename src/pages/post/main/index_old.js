    ...
    <div className="">
      ...
      <div style={{ marginTop: "26px" }}>
        <h6 style={{ fontSize: "10px" }}>
          Here is heading About the blog that is related to their topics
        </h6>
      </div>
    ...
    <div className="container-fluid mt-5" style={{ width: "999px" }}>
      <div className="row">
            ...
            return (
              <Link to={`/post/${d.slug}`}>
                <MainBlogPosts
                  ...
                  height="332.5px"
                  fontSize="22px"
                  imgSrc={d.images.length > 0 && d.images[0].url}
                  desc={d.description}
                  title={d.title}
                />
              </Link>
        ...
        <div className="col-sm-12 col-md-6 col-lg-6">
          <div className="row">
                ...
                <div className="col-sm-12 col-md-12 col-lg-12">
                  <Link to={`/post/${t.slug}`}>
                    <MainBlogPosts
                      ...
                      height="180px"
                      fontSize="20px"
                      imgSrc={t.images.length > 0 && t.images[0].url}
                      desc={t.description}
                      title={t.title}
                    />
                  </Link>
            ...
            <div
              className="col-sm-12 col-md-12 col-lg-12 position-absolute"
              style={{ top: "182.5px" }}
            >
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-6">
                      <Link to={`/post/${e.slug}`}>
                        <MainBlogPosts
                          ...
                          fontSize="12px"
                          height="150px"
                          imgSrc={e.images.length > 0 && e.images[0].url}
                          desc={e.description}
                          title={e.title}
                        />
                      </Link>
      ...
      >
                ...
                .map((i) => {
                  return (
                    <Link to={`/post/${i.slug}`} key={i.slug}>
                      {" "}
                      <DentalPopular
                        imgSrc={i.images.length > 0 && i.images[0].url}
                        title={i.title}
                        desc={i.desc}
                      />
                    </Link>
        ...
        <div className="col-sm-12 col-md-4 col-lg-4">
          ...
          />
          <SocialConnection
            Icon={<AiFillFacebook size={44} color="#3b5998" />}
          />
          <SocialConnection
