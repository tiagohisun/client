...
const PostCategoryCreate = lazy(() => import('./pages/admin/postcategory/PostCategoryCreate.js'));
	...
	return (
		<Suspense fallback={<div className="col text-center p-5">Loading ...</div>}>
			...
			<Switch>
				...
				<AdminRoute exact path="/admin/postcategory/:slug" component={PostCategoryUpdate} />
